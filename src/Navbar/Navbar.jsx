    ...
    <div style={{justifyContent: 'flex-start', alignItems: 'center', gap: 300, display: 'inline-flex'}}>
       ...
       {isDesktop && <div style={{width: 482, position: 'relative'}}>
            <div style={{width: 100, height: 23, left: 213, top: 0, position: 'absolute', justifyContent: 'center', alignItems: 'center', display: 'inline-flex'}}>
                <Link to="/signup" >
                <div style={{textAlign: 'center', color: 'white', fontSize: 20, fontFamily: 'Poppins', fontWeight: '700', wordWrap: 'break-word'}}>Sign Up</div>
                </Link>
                </div>
            ...
            <Link to="/competitions">
                <div style={{textAlign: 'center', color: 'white', fontSize: 20, fontFamily: 'Poppins', fontWeight: '700', wordWrap: 'break-word'}}>Competitions</div>
            </Link >
                </div>
            <div style={{width: 100, height: 23, left: 0, top: 0, position: 'absolute', justifyContent: 'center', alignItems: 'center', display: 'inline-flex'}}>
                <Link to="/aboutus">
                <div style={{textAlign: 'center', color: 'white', fontSize: 20, fontFamily: 'Poppins', fontWeight: '700', wordWrap: 'break-word'}}>About Us</div>
                </Link>
            </div>
        </div> }
