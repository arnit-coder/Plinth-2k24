        ...
        <div className="page2">
          <Tabs selectedIndex={tabIndex} onSelect={handleTabSelect}>
            ...
            <TabPanel className="cards">
              ...
              <EventCard day="Quizzinga" artist="Cryptex" description="Cryptex is an online quiz competition with a format similar to a treasure hunt." image={Cryptex} url='cryptex'/>
              <EventCard day="Quizzinga" artist="IPL Auction" description="IPL Auction is a real-life simulation of the auction we witness before every IPL season." image={iplauction} url='ipl'/>
              <EventCard day="Quizzinga" artist="Brandwagon" description="Brandwagon is Quizzinga's flagship business quiz every year during Plinth." image={bandwagon}  url='brandwagon'/>
